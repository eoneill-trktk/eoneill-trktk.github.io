if (window.location.pathname.includes('/about/')) {
  ...
  function executeCarouselCode() {
    // Check if Slick is already loaded to avoid duplicates
    if (typeof jQuery === 'undefined' || typeof jQuery.fn.slick === 'undefined') {
      ...
      jqueryScript.onload = function () {
        ...
        slickScript.onload = initializeCarousel;
    ...
    function initializeCarousel() {
      ...
      styleTag.textContent = getCarouselStyles();
      ...
      if ($carousel.find('.tl-slide').length > 0) {
        ...
        const containerWidth = $('.tl-carousel-container').width();
        let slidesToShow = 5;
        
        if (containerWidth < 768) slidesToShow = 1;
        else if (containerWidth < 992) slidesToShow = 2;
        else if (containerWidth < 1200) slidesToShow = 3;
