if (window.location.pathname.includes('/join-us/')) {
    ...
    leafletJs.onload = function() {
        ...
        locationElements.forEach(locationEl => {
            ...
            const category = locationEl.classList[1] ? locationEl.classList[1].replace(/-/g, ' ') : '';
            ...
            // Extract address
            const addressElement = locationEl.querySelector('address');
            const address = addressElement ? addressElement.textContent.replace('Address : ', '').trim() : '';
